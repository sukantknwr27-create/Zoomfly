...
function renderNav(activePage = '') {
  ...
  nav.innerHTML = `
    <div class="nav-inner">
      <a href="/index.html" class="logo">
        <img src="/assets/logo.svg" alt="ZoomFly" style="height:38px;width:auto" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"/>
      ...
      <nav class="nav-links">
        <a href="/pages/packages.html" ${activePage==='packages'?'style="color:var(--gold-light)"':''}>Packages</a>
        ...
        <a href="/pages/group-booking.html" ${activePage==='group'?'style="color:var(--gold-light)"':''}>Groups</a>
        <a href="/pages/loyalty.html" ${activePage==='loyalty'?'style="color:var(--gold-light)"':''}>⭐ Rewards</a>
        <a href="/pages/contact.html" class="nav-cta">Book Now</a>
      </nav>
      <div class="nav-auth" id="nav-auth-area">
        <a href="/pages/login.html" class="nav-login-btn" id="nav-login-btn" style="display:flex;align-items:center;gap:6px;padding:6px 16px;border:1.5px solid rgba(255,255,255,0.3);border-radius:50px;font-size:0.82rem;font-weight:600;color:inherit;text-decoration:none;transition:all 0.2s">
          👤 Sign In
        </a>
        <div id="nav-user-menu" style="display:none;position:relative">
          <button id="nav-user-btn" style="display:flex;align-items:center;gap:8px;background:rgba(255,255,255,0.12);border:none;border-radius:50px;padding:5px 14px 5px 5px;cursor:pointer;color:inherit;font-size:0.82rem;font-weight:600" onclick="toggleUserMenu()">
            <div id="nav-avatar" style="width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#1a73e8,#ff6b35);display:flex;align-items:center;justify-content:center;font-size:0.7rem;color:white;font-weight:700">?</div>
            <span id="nav-username">Account</span>
            <span style="font-size:0.65rem">▼</span>
          </button>
          <div id="nav-dropdown" style="display:none;position:absolute;right:0;top:calc(100%+8px);background:white;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 32px rgba(0,0,0,0.15);min-width:180px;z-index:1000;overflow:hidden">
            <a href="/pages/dashboard.html" style="display:flex;align-items:center;gap:10px;padding:12px 16px;font-size:0.85rem;color:#1e293b;text-decoration:none;border-bottom:1px solid #f1f5f9">📊 My Dashboard</a>
            <a href="/pages/my-bookings.html" style="display:flex;align-items:center;gap:10px;padding:12px 16px;font-size:0.85rem;color:#1e293b;text-decoration:none;border-bottom:1px solid #f1f5f9">🎫 My Bookings</a>
            <a href="/pages/loyalty.html" style="display:flex;align-items:center;gap:10px;padding:12px 16px;font-size:0.85rem;color:#1e293b;text-decoration:none;border-bottom:1px solid #f1f5f9">⭐ My Rewards</a>
            <a href="/pages/dashboard.html#section-profile" style="display:flex;align-items:center;gap:10px;padding:12px 16px;font-size:0.85rem;color:#1e293b;text-decoration:none;border-bottom:1px solid #f1f5f9">👤 Profile</a>
            <button onclick="doSignOut()" style="display:flex;align-items:center;gap:10px;padding:12px 16px;font-size:0.85rem;color:#dc2626;background:none;border:none;cursor:pointer;width:100%;text-align:left">🚪 Sign Out</button>
          </div>
        </div>
      </div>
  ...
  document.body.insertAdjacentHTML('beforeend', `
    <div class="mobile-menu" id="mobileMenu">
      ...
      <a href="/pages/loyalty.html" class="mm-link">⭐ Rewards</a>
      ...
      <div style="border-top:1px solid rgba(255,255,255,0.1);margin:8px 0;padding-top:8px">
        ...
        <button onclick="doSignOut()" class="mm-link" id="mm-signout" style="display:none;background:none;border:none;width:100%;text-align:left;color:inherit;cursor:pointer;font-size:inherit">🚪 Sign Out</button>
      </div>
      <div style="border-top:1px solid rgba(255,255,255,0.1);margin:8px 0;padding-top:8px">
        <a href="/pages/vendor-portal.html" class="mm-link" style="font-size:0.8rem;opacity:0.7">🏨 Vendor Portal</a>
        <a href="/pages/agent-portal.html" class="mm-link" style="font-size:0.8rem;opacity:0.7">🤝 Travel Partner Portal</a>
      </div>
    </div>
  `);
