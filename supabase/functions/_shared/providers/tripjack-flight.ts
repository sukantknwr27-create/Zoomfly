// ============================================================
// Provider stub: tripjack-flight.ts
// File: supabase/functions/_shared/providers/tripjack-flight.ts
//
// STATUS: STUB. Tripjack's real flight API (auth, search, fare
// revalidation, book/ticket, cancel) is not implemented yet — this
// project has no Tripjack credentials or API documentation on
// file as of this commit.
//
// Activating "Tripjack" for the flight service in the admin
...
//
// To finish this integration once Tripjack sends API docs +
// sandbox credentials:
...
export class TripjackFlightProvider implements FlightProvider {
  ...
  async search(_params: FlightSearchParams): Promise<FlightResult[]> {
    throw new Error(
      'Tripjack flight provider is not implemented yet. ' +
      'See supabase/functions/_shared/providers/tripjack-flight.ts.'
    );
  }

  async revalidate(_resultId: string): Promise<RevalidateResult> {
    throw new Error('Tripjack flight provider is not implemented yet.');
  }
